   ...
   */
   ...
   private:
      ...
      */
      ...
      void _supprimmeArbre(NoeudDicoSynonymes *arbre);
      void _auxAjouterRadical(NoeudDicoSynonymes *&arbre, const std::string &data);	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	// de pointeurs sur des noeuds de l'arbre représentant les radicaux.
      ...
      NoeudDicoSynonymes* _rechercherArbre(const std::string& radical) const;
      bool _estPresent(const std::string& radical);

      void _auxSupprimerRadical(NoeudDicoSynonymes *&arbre, const std::string &data);
      void _supprimerSuccDroit(NoeudDicoSynonymes *data);
      int _levenshtein(const std::string &mot1, const std::string & mot2,int m, int n) const;
      bool _estArbreAVL(NoeudDicoSynonymes *noeud) const;
